...
const eyeIcons = document.querySelectorAll('.eye-icons use');
...
if (videoWorks) {
  ...
  upperControls.classList.remove('hidden');
}
...
function hideControls() {
  ...
  upperControls.classList.add('hide');
}

// showControls displays the video controls
function showControls() {
  videoControls.classList.remove('hide');
  upperControls.classList.remove('hide');
...
eyeButton.addEventListener('click', updateMostrar);
eyeButton.addEventListener('click', mostrar);
upperControls.addEventListener('mouseenter', showControls);
upperControls.addEventListener('mouseleave', hideControls);
