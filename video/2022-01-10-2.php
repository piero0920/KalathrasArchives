...
<head>
  ...
  <!-- Change date -->
  <title>Lunes-2 2022-01-10</title>
...
<body>
  ...
  <div class="aaa">
      ...
      <div class="container">
        <div class="video-container" id="video-container">
          <div class="playback-animation" id="playback-animation">
            ...
            <!-- Change poster date -->
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2022-01-10.png">
              <!-- Change src $vod[date] -->
            <source src="<?php include "../include/vod.php"; echo $vod[202201102];?>" type="video/mp4"></source>
          </video>
          ...
          <div class="video-controls hidden" id="video-controls">
            ...
            <div class="bottom-controls">
              ...
              <div class="right-controls">
                ...
                <a style="color:transparent;" target="_blank" href="https://drive.google.com/uc?export=download&id=1-mC5h3hgauikyNXxxDV4WpvtEJgm_wmY">   
    ...
    <div class="donde2">
        <!-- Change poster chatVivo="https://i.imgur.com/N2Dh5X6.png" | chatMuerto="https://i.imgur.com/LFAlVOa.png" -->
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/N2Dh5X6.png">
          <!-- Change src $chat[date] -->
        <source type="video/mp4" src="<?php include "../include/chat.php"; echo $chat[202201102];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        <!-- Change title -->
        <h2>DIRECTO UN LUNES DONDE VAMOS A PARAR! YURI ON MADOKA CARNIVAL YAHI</h2>
        <div class="botones">
            <!-- Change/add/remove parts if needed -->
            <a href="2022-01-10" class="icon-button twitter"><i class="material-icons">filter_1</i><span></span></a>
