...
<head>
  ...
  <!-- Change date -->
  <title>Miercoles-1 2021-10-20</title>
  ...
  <div class="aaa">
      ...
      <div class="container">
        <div class="video-container" id="video-container">
          ...
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2021-10-20.png">
              <!-- Change src $vod[date] -->
            <source src="<?php include "../include/vod.php"; echo $vod[202110201];?>" type="video/mp4"></source>
          </video>
          ...
          <div class="video-controls hidden" id="video-controls">
            ...
            <div class="bottom-controls">
              ...
              <div class="right-controls">
                ...
                <a style="color:transparent;" target="_blank" href="https://drive.google.com/uc?export=download&id=1aU3w4tZ-bsvDgotKT6G8uFphlVkx5HTm">   
    ...
    <div class="donde2">
      ...
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/N2Dh5X6.png">
        ...
        <source type="video/mp4" src="<?php include "../include/chat.php"; echo $chat[202110201];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        ...
        <div class="botones">
            ...
            <a href="2021-10-20-2" class="icon-button twitter"><i class="material-icons">filter_2</i><span></span></a>
        </div>
    </div>
  </div>
