...
<head>
  ...
  <!-- Change date -->
  <title>Sabado-2 2021-10-02</title>
  ...
  <div class="aaa">
      ...
      <div class="container">
        <div class="video-container" id="video-container">
          <div class="playback-animation" id="playback-animation">
            ...
            <!-- Change poster date -->
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2021-10-02.png">
              <!-- Change src $vod[date] -->
            <source src="<?php include "../include/vod.php"; echo $vod[202110022];?>" type="video/mp4"></source>
          </video>
          ...
          <div class="video-controls hidden" id="video-controls">
            ...
            <div class="bottom-controls">
              ...
              <div class="right-controls">
                ...
                <a style="color:transparent;" target="_blank" href="https://drive.google.com/uc?export=download&id=1GtwpEMb2YPYfoPy_c8P2rWdoe94ziA1d">   
    ...
    <div class="donde2">
      ...
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/N2Dh5X6.png">
        ...
        <source type="video/mp4" src="<?php include "../include/chat.php"; echo $chat[202110022];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        <!-- Change title -->
        <h2>REPETIMOS! OLD ANIME MOVIE DAY + FINAL MARATON RESIDENT 4 DAMMMMM</h2>
        <div class="botones">
            <!-- Change/add/remove parts if needed -->
            <a href="2022-10-02" class="icon-button twitter"><i class="material-icons">filter_1</i><span></span></a>
