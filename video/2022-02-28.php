<?php include "include/title.php"; include "include/gd.php"; include "include/vod.php"; include "include/chat.php";?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <div class="aaa">
      ...
      <div class="container">
        <div class="video-container" id="video-container">
          <div class="playback-animation" id="playback-animation">
            ...
            <!-- Change poster date -->
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2022-02-28.png">
              <!-- Change src $vod[date] -->
            <source src="<?php echo $vod[20220228];?>" type="video/mp4"></source>
          </video>
          ...
          <div class="video-controls hidden" id="video-controls">
            ...
            <div class="bottom-controls">
              ...
              <div class="right-controls">
                  <!-- Change Download $gd[date] -->
                <a style="color:transparent;" target="_blank" href="<?php echo $gd[20220228];?>">   
    ...
    <div class="donde2">
      ...
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/N2Dh5X6.png">
        ...
        <source type="video/mp4" src="<?php echo $chat[20220228];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        <!-- Change title $title[date] -->
        <h2><?php echo $title[20220228];?></h2>
        <div class="botones">
