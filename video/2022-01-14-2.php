...
<head>
  ...
  <!-- Change date -->
  <title>Viernes-2 2022-01-14</title>
  ...
  <div class="aaa">
      ...
      <div class="container">
        <div class="video-container" id="video-container">
          <div class="playback-animation" id="playback-animation">
            ...
            <!-- Change poster date -->
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2022-01-14.png">
              <!-- Change src $vod[date] -->
            <source src="<?php include "../include/vod.php"; echo $vod[20220114.2];?>" type="video/mp4"></source>
          </video>
    ...
    <div class="donde2">
      ...
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/N2Dh5X6.png">
        ...
        <source type="video/mp4" src="<?php include "../include/chat.php"; echo $chat[20220114.2];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        <!-- Change title -->
        <h2>HA VUELTO! SHINGEKI NO KYOJIN EN 5 MIN KIMETSU Y ANIMES RANDOM DE LA TEMPORADA!</h2>
        <div class="botones">
            <!-- Change/add/remove parts if needed -->
            <a href="2022-01-14" class="icon-button twitter"><i class="material-icons">filter_1</i><span></span></a>
