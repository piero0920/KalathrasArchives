...
<head>
  ...
  <!-- Change date -->
  <title>Viernes-2 2021-08-13</title>
  ...
  <div class="aaa">
      ...
      <div class="container">
        <div class="video-container" id="video-container">
          <div class="playback-animation" id="playback-animation">
            ...
            <!-- Change poster date -->
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2021-08-13.png">
              <!-- Change src $vod[date] -->
            <source src="<?php include "../include/vod.php"; echo $vod[202108132];?>" type="video/mp4"></source>
          </video>
          ...
          <div class="video-controls hidden" id="video-controls">
            ...
            <div class="bottom-controls">
              ...
              <div class="right-controls">
                ...
                <a style="color:transparent;" target="_blank" href="https://drive.google.com/uc?export=download&id=1qMBem5rm4EhToliC7yMsna3T2bkZ0foH">   
    ...
    <div class="donde2">
      ...
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/N2Dh5X6.png">
        ...
        <source type="video/mp4" src="<?php include "../include/chat.php"; echo $chat[202108132];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        <!-- Change title -->
        <h2>HOY ES DIA DE IMPACTO! DE IMPACTANTES ANIMES DE VIERNES! TOKYO - KANOJO - KOBAYASHI - HIGURASHI!!!</h2>
        <div class="botones">
            <!-- Change/add/remove parts if needed -->
            <a href="2021-08-13" class="icon-button twitter"><i class="material-icons">filter_1</i><span></span></a>
