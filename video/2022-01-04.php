  ...
  <div class="aaa">
    <div class="donde">
      <div class="container">
        <div class="video-container" id="video-container">
          ...
          <!-- Change poster date -->  
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2022-01-04.png">
              <!-- Change src $vod[date] -->
            <source src="<?php include "../include/vod.php"; echo $vod[20220104];?>" type="video/mp4"></source>
          </video>
          ...
          <div class="video-controls hidden" id="video-controls">
            ...
            <div class="bottom-controls">
              ...
              <div class="right-controls">
                ...
                <a style="color:transparent;" target="_blank" href="https://drive.google.com/uc?export=download&id=1cUu_x3XmcciG82zKz6HRdRiRrXo1sjHc">   
    ...
    <div class="donde2">
      ...
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/N2Dh5X6.png">
        ...
        <source type="video/mp4" src="<?php include "../include/chat.php"; echo $chat[20220104];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        <!-- Change title -->
        <h2>DIRECTO DE FIN DE AÑO 4 DIAS DESPUES Y JUGANDO DARK SOULS VAMOSSSSSSSSSSSSSSSSSSSSSSSSSSS</h2>
        <div class="botones">
