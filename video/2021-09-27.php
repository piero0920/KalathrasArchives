  ...
  <div class="aaa">
      ...
      <div class="container">
        <div class="video-container" id="video-container">
          <div class="playback-animation" id="playback-animation">
            ...
            <!-- Change poster date -->
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2021-09-27.png">
              <!-- Change src $vod[date] -->
            <source src="<?php include "../include/vod.php"; echo $vod[20210927];?>" type="video/mp4"></source>
          </video>
          ...
          <div class="video-controls hidden" id="video-controls">
            ...
            <div class="bottom-controls">
              ...
              <div class="right-controls">
                ...
                <a style="color:transparent;" target="_blank" href="https://drive.google.com/uc?export=download&id=1CrqywVZRYgeX7TvKAYma4GXnEzweI71E">   
    ...
    <div class="donde2">
      ...
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/N2Dh5X6.png">
        ...
        <source type="video/mp4" src="<?php include "../include/chat.php"; echo $chat[20210927];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        <!-- Change title -->
        <h2>TERMINANDO EL ANIME MAS EPICO DE LA HISTORIA DE ESTE CANAL D_! + Yuri On Ice - Gundam y JahySama!</h2>
        <div class="botones">
