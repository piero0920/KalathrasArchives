...
<head>
  ...
  <!-- Change date -->
  <title>Viernes-5 2021-10-01</title>
...
<body>
  ...
  <div class="aaa">
      ...
      <div class="container">
        <div class="video-container" id="video-container">
          <div class="playback-animation" id="playback-animation">
            ...
            <!-- Change poster date -->
          <video oncontextmenu="return false;" controls class="video" id="video" preload="metadata" poster="/img/2021-10-01.png">
              <!-- Change src $vod[date] -->
            <source src="<?php include "../include/vod.php"; echo $vod[202110015];?>" type="video/mp4"></source>
          </video>
          ...
          <div class="video-controls hidden" id="video-controls">
            ...
            <div class="bottom-controls">
              ...
              <div class="right-controls">
                ...
                <a style="color:transparent;" target="_blank" href="https://drive.google.com/uc?export=download&id=1br2jMWTB3ck_0iTgLM5IWoIz66uA1BqG">   
    ...
    <div class="donde2">
      ...
      <video oncontextmenu="return false;" class="video2" id="video2"  muted poster="https://i.imgur.com/LFAlVOa.png">
          <!-- Change src $chat[date] -->
        <source type="video/mp4" src="<?php include "../include/chat.php"; echo $chat[202110015];?>"></source>
      </video>
    </div>
    <div id="des" class="des">
        <!-- Change title -->
        <h2>OLD ANIME MOVIE DAY! + HIGURASHI END OMG (╯°Д°）╯︵_(.□ . )</h2>
        <div class="botones">
            <!-- Change/add/remove parts if needed -->
            <a href="2022-10-01" class="icon-button twitter"><i class="material-icons">filter_1</i><span></span></a>
            <a href="2022-10-01-2" class="icon-button twitter"><i class="material-icons">filter_2</i><span></span></a>
            <a href="2022-10-01-3" class="icon-button twitter"><i class="material-icons">filter_3</i><span></span></a>
            <a href="2022-10-01-4" class="icon-button twitter"><i class="material-icons">filter_4</i><span></span></a>
            <a class="icon-button twitter"><i class="material-icons">filter_5</i><span></span></a>
        </div>
    </div>
  </div>
